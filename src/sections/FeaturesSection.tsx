...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why Choose Our AI Ads Generator" text3="Transform your text into compelling ads with advanced AI technology and customizable templates." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    PrebuiltUI helps you build faster by transforming your design vision into fully functional, production-ready UI components. Our AI Ads Generator takes this further by converting your text into engaging advertisements automatically.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Our AI Ads Generator empowers marketers to create high-converting ads effortlessly, boosting engagement and sales.</p>
